...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="razmser"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/3r/q326vdrx625dkns5n39k314h0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/razmser/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/razmser/.mailcheckrc"
# }
